...
public class KThread {
	...
	public void join() {
		...
		boolean intStatus = Machine.interrupt().disable();
		//join must be called from only one thread, if two or more threads call the join() for this 
		//particular thread, the behaviour is undefined. Only the thread calling the join first will
		//be waiting 
		if (joinThread == null) {
